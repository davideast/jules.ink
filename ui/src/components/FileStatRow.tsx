...
export function FileStatRow({ status, path, additions, deletions }: FileStatRowProps) {
  return (
    <div className="flex items-center text-[12px] font-mono text-[#72728a] hover:text-soft-white transition-colors cursor-pointer group">
